...
fieldNames = {'Data_Path','Save','RandomFreq','RefMWOff','AutoAlignCrop','AutoAlignCam',...
    ...
    'SaveMode','COM_Lakeshore','COM_Betsa','ResetPiezo','AF','AF_NumberSweeps','AF_Method','LaserShutter','LaserShutterPort',...
    'TR_Period_Minute','DisplayLight','MaxLum','SensorTempA','SensorTempA_Name','SensorTempB','SensorTempB_Name',...
    'SensorTempC','SensorTempC_Name','SensorTempD','SensorTempD_Name',...
    'FileNamePrefix','FileNamePrefixChoice','FileNameUserPrefix'};

defaultValues = {grandparentPath,0,0,0,0,1,0,0,1,0,20,200,20,2.87,200,5,1,'backup',0.1,'ms',AOI,20,40,'pixel',...
        463,1,1,0,0,8,3,6,0.2,0.2,0.5,5,5,11,0.027,294,206,300,200,'slow&compressed',"3","20",1,0,3,...
        'DCTR',1,'1.3',1,0,4096,1,'Diode',1,'Thermocouple',0,'Diode',0,'Thermocouple','PlaceHolder','Date+Base','Data_Acq'};
