...
fieldNames = {'Data_Path','Save','RandomFreq','RefMWOff','AutoAlignCrop','AutoAlignCam',...
    ...
    'SaveMode','COM_Lakeshore','COM_Betsa','ResetPiezo','AF','AF_NumberSweeps','AF_Method','LaserShutter',...
...
defaultValues = {grandparentPath,0,0,0,0,1,0,0,1,0,20,200,20,2.87,200,5,1,'backup',0.1,'ms',AOI,20,40,'pixel',...
        ...
        'DCTR',1,1,0,4096,1,'Diode',1,'Thermocouple',0,'Diode',0,'Thermocouple','PlaceHolder','Date+Base','Data_Acq'};
